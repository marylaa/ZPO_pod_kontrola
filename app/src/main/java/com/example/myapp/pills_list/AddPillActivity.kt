...
/////////////////////////////////////////////////////////////////////////////////
    ...
    private fun savePill(completion: (Boolean) -> Unit)  {
        ...
        if (selectedFrequency.equals("Niestandardowa")) {
            newPill = PillModelNiestandardowo(id, uid, name, amountLeft, amountInBox, frequency, timesNiestandardowe, date, nextDay)
        } else {
            newPill = PillModel(id, uid, name, amountLeft, amountInBox, frequency, times, date, nextDay)
        }
