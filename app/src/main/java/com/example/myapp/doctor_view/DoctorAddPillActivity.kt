...
import com.example.myapp.pills_list.PillModelNiestandardowo
...
class DoctorAddPillActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val elements = arrayOf("Codziennie", "Dwa razy dziennie", "Trzy razy dziennie", "Co drugi dzień", "Raz w tygodniu", "Niestandardowa")
...
/////////////////////////////////////////////////////////////////////////////////
    ...
    private fun savePill(completion: (Boolean) -> Unit) {
        ...
        var time1: Any? = null
        var times1: MutableList<Any?>? = null
        if (hours.get(0) !== null) {
        ...
        var newPill: Any? = null
        if (selectedFrequency.equals("Niestandardowa")) {
            newPill = PillModelNiestandardowo(id, patientId, name, amountLeft, amountInBox, frequency, timesNiestandardowe, date, nextDay)
        } else {
            newPill = PillModel(id, patientId, name, amountLeft, amountInBox, frequency, times, date, nextDay)
        }
